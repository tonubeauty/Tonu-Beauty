...
export const FloatingMobileBar: React.FC<FloatingMobileBarProps> = ({
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-t border-rose-200 p-2.5 shadow-xl flex items-center justify-between gap-2">
      <a
        href="tel:01302383795"
        className="px-3 py-2.5 rounded-xl bg-slate-900 text-white font-bold text-xs flex items-center gap-1.5 shrink-0 hover:bg-slate-800"
      >
      ...
      {onOpenAppointmentModal && (
        <button
          ...
          className="px-3 py-2.5 rounded-xl bg-rose-100 hover:bg-rose-200 text-rose-900 font-bold text-xs flex items-center gap-1.5 shrink-0 border border-rose-200"
        >
